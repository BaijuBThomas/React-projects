...
const ServiceCard = ({service, index}) => {
  ...
  return (
    <div className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border dark:shadow-white/10' onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>setVisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
